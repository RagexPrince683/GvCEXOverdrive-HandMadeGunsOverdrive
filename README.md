...
Release JARs include a vecmath runtime fallback for environments that do not already provide `javax.vecmath`. A separate vecmath JAR is not normally required.
